...
void ModeCustom::update()
{
    ...
    rtU_->measure.EulerAngles[0] = plane.ahrs.get_roll();
    rtU_->measure.EulerAngles[1] = plane.ahrs.get_pitch();
    rtU_->measure.EulerAngles[2] = plane.ahrs.get_yaw();
    ...
    #ifdef CUSTOM_MATLAB_OUTPUT
        socket_debug.sendto(&custom_controller.rtU.measure, sizeof(measureBus), _debug_address, _debug_port); 
    #endif
